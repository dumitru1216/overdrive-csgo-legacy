...
struct GlowObjectDefinition_t
{
	...
	class m_entity* m_pEntity;    //0x0000
	union
	{
...
{
public:
	int RegisterGlowObject( m_entity* pEntity, const Vector& vGlowColor, float flGlowAlpha, bool bRenderWhenOccluded, bool bRenderWhenUnoccluded, int nSplitScreenSlot )
	{
		int nIndex;
	...
	void SetEntity( int nGlowObjectHandle, m_entity* pEntity )
	{
