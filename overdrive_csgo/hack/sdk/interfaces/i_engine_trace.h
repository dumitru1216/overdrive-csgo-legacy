...
public:
	...
	{
		ClientClass* pEntCC = ( ( iclient_entity* )pEntityHandle )->GetClientClass( );
...
{
public:
	CTraceFilterPlayersOnlySkipOne( iclient_entity* ent )
	{
		pEnt = ent;
	}
	bool ShouldHitEntity( IHandleEntity* pEntityHandle, int /*contentsMask*/ )
	{
		return pEntityHandle != pEnt && ( ( iclient_entity* )pEntityHandle )->GetClientClass( )->m_ClassID == 35; // entity 35
	}
	virtual TraceType GetTraceType( ) const
	{
		return TraceType::TRACE_ENTITIES_ONLY;
...
{
public:
	CTraceFilterSkipTwoEntities( iclient_entity* ent1, iclient_entity* ent2 )
	{
		pEnt1 = ent1;
		pEnt2 = ent2;
	}
...
private:
	iclient_entity* pEnt1;
	iclient_entity* pEnt2;
};
