...
public:
	...
	virtual bool RenderBrushModelSurface( iclient_entity* pBaseEntity, IBrushSurface* pBrushSurface ) = 0;
};
...
public:
	virtual void                DrawBrushModel( iclient_entity* baseentity, model_t* model, const Vector& origin, const QAngle& angles, bool sort ) = 0;
	...
	virtual void                DrawBrushModelShadow( iclient_renderable* pRenderable ) = 0;
	...
	virtual void                DrawBrushModelShadowDepth( iclient_entity* baseentity, model_t* model, const Vector& origin, const QAngle& angles, bool bSort ) = 0;
	virtual void                UpdateBrushModelLightmap( model_t* model, iclient_renderable* pRenderable ) = 0;
