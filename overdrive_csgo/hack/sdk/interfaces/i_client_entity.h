...
class iclient_entity : public iclient_unknown, public iclient_renderable, public iclient_networkable, public iclient_thinkable
{
public:
...
public:
	virtual weapon_info_t* GetWpnData( unsigned ItemDefinitionIndex ) = 0;
	virtual CSWeaponInfo_t* GetWpnData2( unsigned ItemDefinitionIndex ) = 0;
};